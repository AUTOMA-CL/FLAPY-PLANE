...
export default function GameCanvas({ onScoreChange, onGameOver }: GameCanvasProps) {
  ...
  useEffect(() => {
    ...
    // Cargar imagen del avión con fallback
    const planeImg = new Image();
    planeImg.onload = onImageLoad;
    planeImg.onerror = () => {
      // Fallback a PNG si WebP/AVIF no están disponibles
    ...
    // Cargar imagen de fondo con fallback
    const backgroundImg = new Image();
    backgroundImg.onload = onImageLoad;
    backgroundImg.onerror = () => {
      // Fallback a JPEG si WebP/AVIF no están disponibles
      backgroundImg.src = '/images/background.jpeg';
    };
    // Intentar cargar WebP primero (sin cache buster)
